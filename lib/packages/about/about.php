...
function about_layout()
{
	...
	$navibars->add_tab_content_row(array(	'<label>'.t(218, 'Third party libraries').'</label>',
											'<a href="http://tinymce.moxiecode.com/" target="_blank">TinyMCE WYSIWYG Javascript editor 3.5.6</a><br />'));
	...
	$navibars->add_tab_content_row(array(	'<label>&nbsp;</label>',												
											'<a href="http://www.jquery.com" target="_blank">jQuery v1.10.2 + jQuery Migrate v1.2.1</a><br />' ));

    $navibars->add_tab_content_row(array(	'<label>&nbsp;</label>',
											'<a href="http://www.jqueryui.com" target="_blank">jQuery UI v1.10.3</a><br />' ));

	$navibars->add_tab_content_row(array(	'<label>&nbsp;</label>',												
											'<a href="http://www.trirand.com/blog/" target="_blank">jqGrid v4.5.4</a><br />' ));

	$navibars->add_tab_content_row(array(	'<label>&nbsp;</label>',												
											'<a href="http://stanlemon.net/pages/jgrowl" target="_blank">jGrowl v1.2.12</a><br />' ));

    $navibars->add_tab_content_row(array(	'<label>&nbsp;</label>',
                                            '<a href="http://ivaynberg.github.com/select2" target="_blank">Select2 v3.4.4</a><br />' ));
