        ...
        buttons: [
            {
                ...
                click: function()
                {
                    ...
                    var weight_min = $("#shipping_methods_dialog-weight_min").inputmask("unmaskedvalue") + 0;
                    var weight_max = $("#shipping_methods_dialog-weight_max").inputmask("unmaskedvalue") + 0;
                    ...
                    var subtotal_min = $("#shipping_methods_dialog-subtotal_min").inputmask("unmaskedvalue") + 0;
                    var subtotal_max = $("#shipping_methods_dialog-subtotal_max").inputmask("unmaskedvalue") + 0;
                    ...
                    var cost = $("#shipping_methods_dialog-cost").inputmask("unmaskedvalue") + 0;
                    ...
                    var tax_value = $("#shipping_methods_dialog-tax_value").inputmask("unmaskedvalue");
