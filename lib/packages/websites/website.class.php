	...
	public function insert()
	{
		...
		$ok = $DB->execute('
			...
			array(
				...
				":resize_uploaded_images" => (is_null($this->resize_uploaded_images)? '' : $this->resize_uploaded_images),
				":comments_enabled_for" => (is_null($this->comments_enabled_for)? '' : $this->comments_enabled_for),
				":comments_default_moderator" => (is_null($this->comments_default_moderator)? '' : $this->comments_default_moderator),
				...
				":mail_address" => (is_null($this->mail_address)? '' : $this->mail_address),
				":mail_password" => (is_null($this->mail_password)? '' : $this->mail_password),
				":contact_emails" => serialize($this->contact_emails),
				":homepage" => (is_null($this->homepage)? '' : $this->homepage),
				":default_timezone" => (is_null($this->default_timezone)? '' : $this->default_timezone),
				...
				":favicon" => (is_null($this->favicon)? '' : $this->favicon),
