...
function navigate_payment_methods_select_language(el)
{
    ...
    $("#description_fields_" + code).css("display", "block");
    $("#payment_fields_" + code).css("display", "block");

    $("#description_language_selector_" + code).attr("checked", "checked");
    $("#payment_language_selector_" + code).attr("checked", "checked");
