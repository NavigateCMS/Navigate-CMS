...
$.extend($.jgrid,{
	...
	edit : {
		...
		msg: {
			...
			novalue : " el valor a retornar és requerit!",
			customarray : "La funció pròpia hauria de retornar una array!",
			customfcheck : "Una funció pròpia hauria d'estar present en el cas de comprovacions especials!"
		}
	},
	view : {
