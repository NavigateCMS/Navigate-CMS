...
class NamePrepData implements NamePrepDataInterface
{
    ...
    public $replaceMaps = array(
            0x41 => array(0x61), 0x42 => array(0x62), 0x43 => array(0x63),
    ...
    public $normalizeCombiningClasses = array(
