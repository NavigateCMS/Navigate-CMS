				...
				$.getJSON(
					...
					function(data)
					{
						...
						$(ctrl_input_href).parents('.mce-floatpanel').find('ul.tinymce_nv_link_ajax_selector:last')
							.css({
								top: $(ctrl_input_href).offset().top + $(ctrl_input_href).height() - $(ctrl_input_href).parents('.mce-floatpanel').offset().top,
								left: $(ctrl_input_href).offset().left - $(ctrl_input_href).parents('.mce-floatpanel').offset().left,
