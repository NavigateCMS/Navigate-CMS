...
class Dumper
{
	...
	const LOCATION_SOURCE = 1; //0b0001; // shows where dump was called
	const LOCATION_LINK = 2; //0b0010; // appends clickable anchor
	const LOCATION_CLASS = 4; //0b0100; // shows where class is defined
