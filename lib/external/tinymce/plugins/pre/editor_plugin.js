	...
	tinymce.create('tinymce.plugins.PrePlugin', {		
		init : function(ed, url) {			
			...
			ed.addCommand('mcePre', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 600 + parseInt(ed.getLang('pre.delta_width', 0)),
					height : 400 + parseInt(ed.getLang('pre.delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url
				});
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://code.google.com/p/tinymce-pre-plugin/',
				version : "1.0"
			};
		},
